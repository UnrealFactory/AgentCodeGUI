  ...
  },
  {
    ...
    desc: (
      <>
        ...
        <b>Ctrl+F 대화 검색</b>, 드래그하면 뜨는 복사·“더 자세히” 툴바, 채팅별 프롬프트까지. 실행 중에도{' '}
  ...
  },
  {
    ...
    desc: (
      <>
        ...
        (로그인/로그아웃), <b>API</b>에선 키(<b>암호화 저장</b>)·예산과 <b>모델별·일별 사용 통계</b>를
        관리합니다. API 모드에선 5시간 한도 대신 <b>대화 비용과 남은 예산</b>이 보여요.
      </>
    )
  },
  {
