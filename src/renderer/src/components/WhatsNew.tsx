...
const SLIDES: Slide[] = [
  {
    ...
    desc: (
      <>
        ...
        IDE예요. 별도 API 키 없이 기존 로그인 그대로 — <b>채팅·에이전트·멀티</b> 세 모드, 자체
  ...
  },
  {
    ...
    desc: (
      <>
        ...
        구조화된 호버 카드. <b>읽기·편집 모드</b>를 오가고 <b>변경/일반 토글(Ctrl+D)</b>로 diff를
        켜고 끄며 제자리에서 고치고, C#·TS·Python·<b>Verse</b> 등 분석은 디스크 캐시로 <b>다시 켜도
        거의 즉시</b> 떠요.
      </>
    )
  },
  ...
  },
  {
    ...
    desc: (
      <>
        ...
        복사·“더 자세히” 툴바, 채팅별 프롬프트까지 — 채팅·에이전트·멀티 어디서나 똑같이.
      </>
    )
  },
  {
