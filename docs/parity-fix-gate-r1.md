...
| 주행 | 결과 |
|---|---|
| **연속 10회** | **10/10 초록** · 매 회 `161 passed; 0 failed` · 1.49 ~ 4.15s |
| **부하 겹친 3회**(`node tools/churn.mjs --par=60`, 실측 264 spawn/s ≈ 프로세스 생성·소멸 **~530/s**) | **3/3 초록** · 1.60 / 1.60 / 1.62s |
| (그 전 판, 기능 동일·주석만 다름) 연속 10회 + 부하 4회 | 10/10 · 4/4 초록 |
...
| 주행 | 결과 |
|---|---|
| 전체 주행 1회 | **FAILED** — `160 passed; 1 failed` |
| 취소 셋만 3회 | **3/3 붉음** (매 회 `2 passed / 1 failed`) |
