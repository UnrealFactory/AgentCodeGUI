window.PROGRESS = {
  phase: '크리틱 라운드 — M1 R3 실측 재현·반박 + M-UX/M-LOGIC 설계 구멍 사냥 (병렬 2)',
  note: 'R3 핵심 발견: 앱 몫은 8.4MB뿐, 나머지는 WebView2 바닥값 — WS 목표(≤356)는 미지원 스위치(--single-process) 없이는 실측상 불가. 콜드 첫 창 ≤168도 웹 런타임 기동(202~240ms)이 하한이라 구조적 미달. 사용자 결정 대기 항목이 쌓이는 중(single-process 채택 여부·UX 열린 문제 10건)',
  updatedAt: '2026-08-22 19:10',
  metrics: [
