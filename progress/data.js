window.PROGRESS = {
  phase: 'R22 — M11 토큰 안전 잠금(치명 C1) / M9 칩 수명 / M10 안전 공격 크리틱 (병렬 3) — 신기능 3종 전부 실물 상태',
  ...
  pieces: [
    ...
    { name: 'M10 신기능: 세션 간 협업', scope: '착지 — crosstalk 라우터(보드 옵트인·홉 상한 4·긴급 정지·차단 실차단·봉투 경고가 실 CLI에서 먹힘)·실 3턴 왕복 PoC·워크스페이스 475 green. 크리틱 안전 공격 중', state: 'build', round: 1 },
