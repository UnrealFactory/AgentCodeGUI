window.PROGRESS = {
  phase: 'R4 착지 — 크래시 복구 실증·설계 R2 완료. NetSvc2 FPS 재판정(교대 하네스) 진행 중 → 끝나면 R4 크리틱',
  note: 'M1 R4: 렌더러 크래시 복구 479ms·브라우저 크래시 1.4s 실증(유령 창 블로커 해소), 하네스 결함 6건 수정(앱 몫 실제 45.6MB로 정정), 콜드 첫 픽셀 278 vs 613 = 0.45 승리 공식화. M-UX R2: 감시자를 Rust로 이관(접힘 채팅 감시 구멍 해소)+156화면 사영표(미배정 0). M-LOGIC R2: 전이 31→58(프레임 전수 사영)·재생 8/8 온전. 사용자 결정 대기: WS/콜드 목표 재협상·UX 열린 문제',
  updatedAt: '2026-08-22 22:30',
  metrics: [
    { name: '★ 멀티 4패널 유휴 WS', unit: 'MB', base: 712.8, new: 450.7, target: '≤356 = WebView2 빈 문서 바닥값(351~387) 선상 — 재협상 대상. NetSvc2 채택 시 426.3', pass: false },
    { name: '★ 멀티 4패널 유휴 Private', unit: 'MB', base: 505.3, new: 248.1, target: '≤253 (범위 247.6~253.4 — 선상). NetSvc2면 241.6', pass: false },
    { name: '★ 멀티 4패널 + 추가 창 2개 WS', unit: 'MB', base: 934.1, new: 500.9, target: '≤467. NetSvc2면 471.8', pass: false },
    ...
    { name: '★ 렌더러 크래시 복구 (R4 신설·블로커 해소)', unit: 'ms', base: null, new: 479, target: '유령 창 0 — 렌더러 479ms·브라우저 1448ms 자동 복구, 정상 종료 오인 가드 실증', pass: true },
    { name: '콜드 첫 픽셀 paintMs (R4 공정화)', unit: 'ms', base: 613, new: 278, target: '비 0.45 — 3.0의 ≤0.5 승점', pass: true },
