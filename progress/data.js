window.PROGRESS = {
  phase: 'M0 — 기준 실측',
  note: '2.6.2 프로덕션 번들을 격리 홈으로 부팅해 콜드 스타트·유휴 메모리 측정 중',
  updatedAt: '2026-08-22 (세션 시작)',
  metrics: [
    ...
    { name: '긴 스레드 스크롤 평균 FPS', unit: '', base: null, new: null, target: '동등 이상' },
    { name: '스트리밍 중 프레임 드랍', unit: '%', base: null, new: null, target: '동등 이하' },
    { name: '설치 풋프린트', unit: 'MB', base: 650, new: null, target: '대폭 감소' }
  ],
  pieces: [
    { name: 'M0 기준 실측', scope: '2.6.2 수치 박제 (콜드 스타트·메모리·스크롤·스트리밍)', state: 'build' },
    { name: 'M1 아키텍처+셸', scope: 'Tauri 워크스페이스·창 시스템·api 심·렌더러 이식 빌드', state: 'wait' },
